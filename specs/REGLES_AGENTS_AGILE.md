...
| Code | Nom | Principe |
|------|-----|----------|
| L0 | Auto-application | Ces lois s'appliquent à tout projet et à la conception d'Albert. |
...
|------|-------|-------------|
| R-0 (Albert Business Analyst) | L1, L4 | Anti-précipitation, Gabarit CDC (Cahier des charges) |
| R-2 (Albert System Architect) | L2, L5, L18 | Traçabilité verticale, Confinement spatial, Arrêt sur contradiction |
| R-3 (Albert Scrum Master) | L6 | V.A.R. — Plans exécutables, nomenclature 4D |
| R-4 (Albert Dev Team) | L8, L9, L19, L21 | Non-destruction, Zéro-hardcode, Idempotence, Doc-as-code + Règles Tests |
| R-5 (Albert Release Manager) | L7, L8 | Transparence, Non-destruction (git allowlist) |
| R-6 (Albert QA & DevOps) | L15, L21 | Intégration E2E, Doc-as-code + Règles Tests |
...
## 4. Validation R-1 (Nghia Product Owner) / R-7 (Nghia Stakeholder)
...
- R-2 (Albert System Architect) et R-4 (Albert Dev Team) : artefacts IA en `.operations/artifacts` avant promotion par R-1 (Nghia Product Owner) / R-7 (Nghia Stakeholder).
